module Htmltoword
  module HtmltowordHelper
    ...
    def template_file template_file_name=nil
      ...
      return default_path unless template_file_name && !template_file_name.empty?

      template_path = File.join(::Htmltoword.config.custom_templates_path, template_file_name)
